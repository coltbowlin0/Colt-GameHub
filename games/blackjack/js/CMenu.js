function CMenu(){
    ...
    this._init = function(){
        ...
        if (_fRequestFullScreen && screenfull.isEnabled){
            ...
            _pStartPosCredits = {x:_pStartPosFullscreen.x + 10 + oSprite.width/2,y:(oSprite.height / 2) + 200};
        }else{
            _pStartPosCredits = {x:10 + oSpriteCredits.width/2,y:(oSpriteCredits.height / 2) + 250};
        }
